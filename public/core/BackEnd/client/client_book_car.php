<?php
  ...
  //register staff
		...
		if(isset($_POST['book_car']))
		{
            ...
            $query="INSERT INTO tkchms_bookings (c_id, cc_id, car_id, car_name, car_type, car_regno, b_duration, c_name, c_natidno, c_phone, b_number, car_price) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
   ...
   <?php include("inc/nav.php");?>
    ...
    <div class="container-fluid mt--7">
        <?php
            ...
            $car_id = $_GET['car_id'];
            $ret="SELECT  * FROM  tkchms_cars  WHERE car_id=?";
                    ...
                    <form method="post" enctype="multipart/form-data" >
                        <div class="row">
                            ...
                            <div class="form-group col-md-6" style="display:none">
                                <label for="exampleInputEmail1">Booking Numbe</label>
                                    ...
                                    ?>
                                <input type="text" required name="b_number" value="tkchms-B-<?php echo $alph_num;?>-<?php echo $num;?> " class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <?php
                                ...
                                $c_id = $_SESSION['c_id'];
                                $ret="SELECT  * FROM  tkchms_clients  WHERE c_id=?";
                                $stmt= $mysqli->prepare($ret) ;
