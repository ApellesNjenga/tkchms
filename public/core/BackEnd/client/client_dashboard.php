                    ...
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">My Hired Cars</h5>
                        <?php
                              ...
                              $c_id = $_SESSION['c_id'];
                              $result ="SELECT count(*) FROM tkchms_bookings  WHERE c_id = ? AND  b_status  = 'Approved'  ";
                    ...
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Available Cars</h5>
                        <?php
                              ...
                              $result ="SELECT count(*) FROM tkchms_cars WHERE car_status = 'Available'  ";
                              $stmt = $mysqli->prepare($result);
                              $stmt->execute();
                  ...
                  <div class="row">
                    <div class="col">
                      ...
                      <?php
                          ...
                          $c_id = $_SESSION['c_id'];
                          $result ="SELECT SUM(p_amt) FROM tkchms_car_payments WHERE c_id =? ";
                          $stmt = $mysqli->prepare($result);
                          $stmt ->bind_param('i', $c_id);
                          $stmt->execute();
          ...
          dataPoints: [
            { 
              y:
                <?php
                  //code for summing up number of hatch backs
                  $c_id = $_SESSION['c_id'];
                  $result ="SELECT count(*) FROM tkchms_bookings WHERE c_id =? AND car_type  = 'Hatchback' AND b_status ='Approved' ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->bind_param('i', $c_id);
                  $stmt->execute();
                  $stmt->bind_result($hatchback);
            ...
            { y:
                <?php
                    //code for summing up number of Sedan | Saloon
                    $c_id = $_SESSION['c_id'];
                    $result ="SELECT count(*) FROM tkchms_bookings WHERE c_id = ? AND  car_type  = 'Sedan | Saloon' AND b_status ='Approved' ";
                    $stmt = $mysqli->prepare($result);
                    $stmt->bind_param('i', $c_id);
                    $stmt->execute();
                    $stmt->bind_result($sedan);
            ...
            { y:
              <?php
                    //code for summing up number of Multi-Purpose Vehicle (MPV)
                    $c_id = $_SESSION['c_id'];
                    $result ="SELECT count(*) FROM tkchms_bookings WHERE c_id = ? AND  car_type  = 'Multi-Purpose Vehicle (MPV)' AND b_status ='Approved' ";
                    $stmt = $mysqli->prepare($result);
                    $stmt->bind_param('i', $c_id);
                    $stmt->execute();
                    $stmt->bind_result($MPV);
            ...
            { y:
              <?php
                    //code for summing up number of Sports Utility Vehicle (SUV)
                    $c_id = $_SESSION['c_id'];
                    $result ="SELECT count(*) FROM tkchms_bookings WHERE c_id =? AND  car_type  = 'Sports Utility Vehicle (SUV)' AND b_status ='Approved' ";
                    $stmt = $mysqli->prepare($result);
                    $stmt->bind_param('i', $c_id);
                    $stmt->execute();
                    $stmt->bind_result($SUV);
            ...
            { y: 
              <?php
                    //code for summing up number of Crossover
                    $c_id = $_SESSION['c_id'];
                    $result ="SELECT count(*) FROM tkchms_bookings WHERE c_id =? AND  car_type  = 'Crossover' AND b_status ='Approved' ";
                    $stmt = $mysqli->prepare($result);
                    $stmt->bind_param('i', $c_id);
                    $stmt->execute();
                    $stmt->bind_result($Crossover);
            ...
            { y:
              <?php
                    //code for summing up number of Coupe
                    $c_id = $_SESSION['c_id'];
                    $result ="SELECT count(*) FROM tkchms_bookings WHERE c_id =? AND car_type  = 'Coupe' AND b_status ='Approved' ";
                    $stmt = $mysqli->prepare($result);
                    $stmt->bind_param('i', $c_id);
                    $stmt->execute();
                    $stmt->bind_result($Coupe);
            ...
            { y:
              <?php
                    //code for summing up number of Convertible
                    $c_id = $_SESSION['c_id'];
                    $result ="SELECT count(*) FROM tkchms_bookings WHERE c_id = ? AND car_type  = 'Convertible' AND b_status ='Approved' ";
                    $stmt = $mysqli->prepare($result);
                    $stmt->bind_param('i', $c_id);
                    $stmt->execute();
                    $stmt->bind_result($Convertible);
