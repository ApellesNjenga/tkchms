                    ...
                    <!-- Projects table -->
                        <table class="table align-items-center table-flush">
                            ...
                            //get details of all cars
                                    $c_id = $_SESSION['c_id'];
                                    $ret="SELECT * FROM tkchms_bookings WHERE c_id = ?  ORDER BY RAND() "; 
                                ...
                                <td>
                                    <?php 
                                        if($row->b_status != 'Approved')
                                        {
                                            echo 
                                                "
                                                <a href  ='client_cancel_bookings.php?car_id=$row->car_id&b_id=$row->b_id' class='badge badge-warning'>
                                        ...
                                        else
                                        {
                                                echo
                                                "
                                                 <span class='badge badge-danger'>Already Approved!</span>
