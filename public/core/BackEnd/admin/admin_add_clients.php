<?php
  ...
  //register user
		...
		if(isset($_POST['reg_user']))
		{
            ...
            $query="INSERT INTO tkchms_clients (c_number, c_name, c_natidno, c_phone, c_dob, c_adr, c_email, c_pwd, c_dpic) VALUES (?,?,?,?,?,?,?,?,?)";
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6" style="display:none">
                                <label for="exampleInputEmail1">Client Number</label>
                                    ...
                                    ?>
                                <input type="text" required name="c_number" value="tkchms-C-<?php echo $alph_num;?>-<?php echo $num;?> " class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
                            <div class="form-group col-md-6">
