<?php
  ...
  //register staff
		...
		if(isset($_POST['update_staff']))
		{
            ...
            $query="UPDATE tkchms_staff SET s_no =?, s_name=?, s_natidno=?, s_phone=?, s_adr=?, s_email=?, s_pwd=?, s_dpic=? WHERE s_id=?";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('ssssssssi', $s_no, $s_name, $s_natidno, $s_phone, $s_adr, $s_email, $s_pwd, $s_dpic, $s_id);
            $stmt->execute();
   ...
   <?php include("inc/nav.php");?>
    ...
    <div class="container-fluid mt--7">
        <?php
            ...
            $s_id = $_GET['s_id'];
            $ret="SELECT  * FROM  tkchms_staff  WHERE s_id=?";
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6" style="display:none">
                                <label for="exampleInputEmail1">Staff Number</label>
                                    ...
                                    ?>
                                <input type="text" required name="s_no" value="tkchms-S-<?php echo $alph_num;?>-<?php echo $num;?> " class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
