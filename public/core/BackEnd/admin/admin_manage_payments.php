                    ...
                    <!-- Projects table -->
                        <table class="table align-items-center table-flush">
                            ...
                            //get details of all cars
                                    $ret="SELECT * FROM tkchms_bookings WHERE b_status = 'Approved' ORDER BY RAND() "; 
                            ...
                            ?>
                                ...
                                //show pay button if its not paid
                                   if($row->b_payment != 'Paid')
                                   {
                                    echo 
                                        "   
                                        <a class='badge badge-success' href='admin_add_payment.php?b_id=$row->b_id&car_cat_id=$row->cc_id&car_id=$row->car_id'>
