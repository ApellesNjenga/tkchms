<?php
  ...
  //register staff
		...
		if(isset($_POST['book_car']))
		{
            ...
            $query="INSERT INTO tkchms_bookings (a_id, cc_id, car_id, car_name, car_type, car_regno, b_duration, c_name, c_natidno, c_phone, b_number, car_price) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
                    ...
                    <form method="post" enctype="multipart/form-data" >
                        ...
                        <div class="row">
                            ...
                            <?php
                                ...
                                $a_id = $_SESSION['a_id'];
                                $ret="SELECT  * FROM  tkchms_admin  WHERE a_id=?";
                                $stmt= $mysqli->prepare($ret) ;
