<?php
  ...
  //register staff
		...
		if(isset($_POST['pay_hire']))
		{
            ...
            $query1="INSERT INTO tkchms_car_payments (a_id, car_cat_id, car_id, car_name, car_type, car_regno, b_duration, c_name, c_natidno, p_method, p_code, p_amt, p_ref_number) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
            $query2="UPDATE tkchms_bookings SET b_payment = ? WHERE b_id =?";
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6" style="display:none">
                                <label for="exampleInputEmail1">Payment Code</label>
                                    ...
                                    ?>
                                <input type="text" required name="p_code" value="tkchms-P-<?php echo $alph_num;?>-<?php echo $num;?> " class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
