<?php
  ...
  //register staff
		...
		if(isset($_POST['return_car']))
		{
            ...
            $b_id = $_GET['b_id'];
            $car_id = $_GET['car_id'];
            $b_car_return_status = $_POST['b_car_return_status'];
            $car_status = $_POST['car_status'];
        
            //sql to insert captured values
            $query1="UPDATE tkchms_bookings SET b_car_return_status =? WHERE b_id =? ";
            $query2="UPDATE tkchms_cars SET car_status =? WHERE car_id =? ";

            $stmt1 = $mysqli->prepare($query1);
            $stmt2 = $mysqli->prepare($query2);

            $rc=$stmt1->bind_param('si', $b_car_return_status, $b_id);
   ...
   <?php include("inc/nav.php");?>
    ...
    <div class="container-fluid mt--7">
        <?php
            ...
            $b_id = $_GET['b_id'];
            $ret="SELECT  * FROM  tkchms_bookings  WHERE b_id=?";
        ...
        <div class="row">
            <div class="card col-md-12">
                <h2 class="card-header">Return <?php echo $row->car_name;?></h2>
                <div class="card-body">
                    <!--Form-->
                    <form method="post" enctype="multipart/form-data" >
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4" style="display:none">
                                <label for="exampleInputEmail1">Car Return Status</label>
                                <input type="text" required readonly name="b_car_return_status" readonly value="Returned" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
                        ...
                        <?php }?>
                        <button type="submit" name="return_car" class="btn btn-outline-success">Return Car</button>
                    </form>
                    <!-- ./ Form -->
                </div>    
            </div>
