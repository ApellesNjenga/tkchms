                  ...
                  <div class="row">
                    <div class="col">
                      ...
                      <?php
                          ...
                          $result ="SELECT count(*) FROM tkchms_clients ";
                    ...
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Hired Cars</h5>
                        <?php
                              ...
                              $result ="SELECT count(*) FROM tkchms_cars WHERE  car_status  = 'Hired' ";
                              $stmt = $mysqli->prepare($result);
                              $stmt->execute();
                    ...
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Cars</h5>
                        <?php
                              ...
                              $result ="SELECT count(*) FROM tkchms_cars ";
                              $stmt = $mysqli->prepare($result);
                              $stmt->execute();
                    ...
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Car Hiring</h5>
                        <?php
                              ...
                              $result ="SELECT count(*) FROM tkchms_bookings WHERE b_status ='Approved' AND b_payment = 'Paid' ";
                              $stmt = $mysqli->prepare($result);
                              $stmt->execute();
                  ...
                  <div class="row">
                    <div class="col">
                      ...
                      <?php
                          ...
                          $result ="SELECT SUM(p_amt) FROM tkchms_car_payments ";
                          $stmt = $mysqli->prepare($result);
                          $stmt->execute();
                    ...
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Car Types</h5>
                        <?php
                              ...
                              $result ="SELECT count(*) FROM tkchms_car_categories ";
                              $stmt = $mysqli->prepare($result);
                              $stmt->execute();
                  ...
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Returns</h5>
                        <?php
                              //code for summing up number of bookings
                              $result ="SELECT count(*) FROM tkchms_bookings WHERE b_car_return_status  = 'Returned' ";
                              $stmt = $mysqli->prepare($result);
                              $stmt->execute();
                              $stmt->bind_result($booking);
                              $stmt->fetch();
          ...
          dataPoints: [
            { 
              y:
                <?php
                  ...
                  $result ="SELECT count(*) FROM tkchms_cars WHERE car_type  = 'Hatchback' ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
            ...
            { y:
                <?php
                    ...
                    $result ="SELECT count(*) FROM tkchms_cars WHERE car_type  = 'Sedan | Saloon' ";
                    $stmt = $mysqli->prepare($result);
                    $stmt->execute();
            ...
            { y:
              <?php
                    ...
                    $result ="SELECT count(*) FROM tkchms_cars WHERE car_type  = 'Multi-Purpose Vehicle (MPV)' ";
                    $stmt = $mysqli->prepare($result);
                    $stmt->execute();
            ...
            { y:
              <?php
                    ...
                    $result ="SELECT count(*) FROM tkchms_cars WHERE car_type  = 'Sports Utility Vehicle (SUV)' ";
                    $stmt = $mysqli->prepare($result);
                    $stmt->execute();
            ...
            { y: 
              <?php
                    ...
                    $result ="SELECT count(*) FROM tkchms_cars WHERE car_type  = 'Crossover' ";
                    $stmt = $mysqli->prepare($result);
                    $stmt->execute();
            ...
            { y:
              <?php
                    ...
                    $result ="SELECT count(*) FROM tkchms_cars WHERE car_type  = 'Coupe' ";
                    $stmt = $mysqli->prepare($result);
                    $stmt->execute();
            ...
            { y:
              <?php
                    ...
                    $result ="SELECT count(*) FROM tkchms_cars WHERE car_type  = 'Convertible' ";
                    $stmt = $mysqli->prepare($result);
                    $stmt->execute();
          ...
          dataPoints: [
            { 
              y:
                <?php
                  //code for summing up number of hatch backs
                  $result ="SELECT count(*) FROM tkchms_bookings WHERE car_type  = 'Hatchback' AND b_status ='Approved' ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
                  $stmt->bind_result($hatchback);
                  $stmt->fetch();
            ...
            { y:
                <?php
                    //code for summing up number of Sedan | Saloon
                    $result ="SELECT count(*) FROM tkchms_bookings WHERE car_type  = 'Sedan | Saloon' AND b_status ='Approved' ";
                    $stmt = $mysqli->prepare($result);
                    $stmt->execute();
                    $stmt->bind_result($sedan);
                    $stmt->fetch();
            ...
            { y:
              <?php
                    //code for summing up number of Multi-Purpose Vehicle (MPV)
                    $result ="SELECT count(*) FROM tkchms_bookings WHERE car_type  = 'Multi-Purpose Vehicle (MPV)' AND b_status ='Approved' ";
                    $stmt = $mysqli->prepare($result);
                    $stmt->execute();
                    $stmt->bind_result($MPV);
                    $stmt->fetch();
            ...
            { y:
              <?php
                    //code for summing up number of Sports Utility Vehicle (SUV)
                    $result ="SELECT count(*) FROM tkchms_bookings WHERE car_type  = 'Sports Utility Vehicle (SUV)' AND b_status ='Approved' ";
                    $stmt = $mysqli->prepare($result);
                    $stmt->execute();
                    $stmt->bind_result($SUV);
                    $stmt->fetch();
            ...
            { y: 
              <?php
                    //code for summing up number of Crossover
                    $result ="SELECT count(*) FROM tkchms_bookings WHERE car_type  = 'Crossover' AND b_status ='Approved' ";
                    $stmt = $mysqli->prepare($result);
                    $stmt->execute();
                    $stmt->bind_result($Crossover);
                    $stmt->fetch();
            ...
            { y:
              <?php
                    //code for summing up number of Coupe
                    $result ="SELECT count(*) FROM tkchms_bookings WHERE car_type  = 'Coupe' AND b_status ='Approved' ";
                    $stmt = $mysqli->prepare($result);
                    $stmt->execute();
                    $stmt->bind_result($Coupe);
                    $stmt->fetch();
            ...
            { y:
              <?php
                    //code for summing up number of Convertible
                    $result ="SELECT count(*) FROM tkchms_bookings WHERE car_type  = 'Convertible' AND b_status ='Approved' ";
                    $stmt = $mysqli->prepare($result);
                    $stmt->execute();
                    $stmt->bind_result($Convertible);
                    $stmt->fetch();
