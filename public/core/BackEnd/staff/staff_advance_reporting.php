                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <?php
                                //get details of recently joined clients
                                    $ret="SELECT * FROM tkchms_clients ORDER BY RAND() LIMIT 10 "; 
                    ...
                    <!-- Projects table -->
                        <table class="table align-items-center table-flush">
                            ...
                            //get details of all cars
                                    $ret="SELECT * FROM tkchms_cars  ORDER BY RAND() "; 
                                    $stmt= $mysqli->prepare($ret) ;
                                    $stmt->execute() ;//ok
                                    $res=$stmt->get_result();
                                    $cnt=1;
                    ...
                    <!-- Projects table -->
                        <table class="table align-items-center table-flush">
                            ...
                            //get details of all cars hiring payment records
                                    $ret="SELECT * FROM tkchms_car_payments    ORDER BY RAND() "; 
                                    $stmt= $mysqli->prepare($ret) ;
                                    $stmt->execute() ;//ok
                                    $res=$stmt->get_result();
                                    $cnt=1;
                            ...
                            ?>
                                ...
                                <td>
                                    <a href="staff_generate_receipt.php?p_id=<?php echo $row->p_id;?>" class="badge badge-success">
