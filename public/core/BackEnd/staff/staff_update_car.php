<?php
  ...
  //register car
		...
		if(isset($_POST['update_car']))
		{
            ...
            $query="UPDATE  tkchms_cars SET car_cat_id = ?, car_regno = ?, car_name = ?, car_price =?, car_type = ?, car_features = ?, exterior_img = ?, rear_img = ?, interior_img = ?, front_img =? car_id = ?";
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" name="car_type" onChange="getCarCategoryId(this.value);" id="car_type" >
                                        ...
                                        <?php
                                            ...
                                            $ret="SELECT * FROM tkchms_car_categories ORDER BY RAND() LIMIT 10 "; 
                                            $stmt= $mysqli->prepare($ret) ;
                                            $stmt->execute() ;//ok
                                            $res=$stmt->get_result();
                                            $cnt=1;
