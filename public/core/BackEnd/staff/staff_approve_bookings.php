<?php
  ...
  if(isset($_GET['delete_booking']))
  {
        ...
        $adn="DELETE FROM  tkchms_bookings WHERE b_id = ?";
                    ...
                    <!-- Projects table -->
                        <table class="table align-items-center table-flush">
                            ...
                            //get details of all cars
                                    $ret="SELECT * FROM tkchms_bookings  ORDER BY RAND() "; 
                                ...
                                <td>
                                    <?php 
                                        if($row->b_status != 'Approved')
                                        {
                                            echo 
                                                "
                                                    <a href  ='staff_approve_single_booking.php?car_id=$row->car_id&b_id=$row->b_id' class='badge badge-success'>
                                            ...
                                            else
                                            {
                                                echo 
                                                "
                                                <a href  ='staff_disaprove_bookings.php?car_id=$row->car_id&b_id=$row->b_id' class='badge badge-warning'>
