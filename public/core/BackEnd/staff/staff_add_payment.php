<?php
  ...
  //register staff
		...
		if(isset($_POST['pay_hire']))
		{
            ...
            $query1="INSERT INTO tkchms_car_payments (c_id, car_cat_id, car_id, car_name, car_type, car_regno, b_duration, c_name, c_natidno, p_method, p_code, p_amt, p_ref_number) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
