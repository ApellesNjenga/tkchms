...
?>
	...
	<head>
		...
		<!-- Author Meta -->
		<meta name="author" content="njengadeveloper Inc.">
		<!-- Meta Description -->
				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-center">
						<div class="banner-content col-lg-12 col-md-6 ">
							<h6 class="text-white ">TEMBEA KENYA CAR HIRE COMPANY.</h6>
							<h1 class="text-white text-uppercase">
								The Royal Essence of Journey
							</h1>
							<p class="pt-20 pb-20 text-white">
									Welcome to Tembea Kenya Car Hire Company, Search, hire, drive your dream car and travel hassle-free.
							</p>
					...
					<div class="row">
						<div class="col-lg-4 col-md-6">
							<div class="single-feature">
								...
								<p>
									Renting cars is our main job here at TEMBEA KENYA CAR HIRE COMPANY and we have perfected our skills over the years which makes our clients fully satisfied for we have solved their travel mystery.
								</p>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
				...
				<div class="container-fluid">				
					<div class="row justify-content-center align-items-center">
						...
						<div class="col-lg-6 no-padding home-about-right">
							<h1>TEMBEA KENYA CAR HIRE COMPANY<br>
							</h1>
							<p>
							...
							<p>
								...
								Worry no more because here at Tembea Kenya Car Hire Company we take away that dillemma and let you drive your dream car for a couple of days,
					...
					<div class="row">
						<div class="col-lg-4 col-md-6">
							<div class="single-review">
								...
								<p>
									Our team when its travelling to countryside or around the town we always hire cars from Tembea Kenya Car Hire Company and they do not fail us.
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-review">
								...
								<p>
									...
									service vehicle which tends to be insecure, expensive and slow we always head straight for Tembea Kenya Car Hire Company which is always one call away, and 
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-review">
								...
								<p>
									...
									my instution for any lectures or co curriclular activies i just hire a car of my choice from Tembea Kenya Car Hire Company and trust me they 
									do not dissapoint, these guys they are professionals at their job. Thanks Tembea Kenya Car Hire Company.
								</p>
								<div class="star">
									<span class="fa fa-star checked"></span>
									<span class="fa fa-star checked"></span>
						...
						<?php
							...
							$ret="SELECT * FROM tkchms_feedbacks WHERE f_status = 'Published'  ORDER BY RAND() "; 
